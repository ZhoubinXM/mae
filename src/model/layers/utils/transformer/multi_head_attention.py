...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self,
        ...
        self.out_proj = nn.Linear(self.vdim,
                                  self.vdim,
                                  bias=bias,
                                  **factory_kwargs)
        ...
        if add_bias_kv:
            ...
            self.bias_v = Parameter(
                torch.empty((1, 1, self.vdim), **factory_kwargs))
        else:
    ...
    def forward(self,
                ...
                key_batch_cnt=None,
                index_pair_batch=None) -> Tuple[Tensor, Optional[Tensor]]:
        r"""
    Args:
...
def multi_head_attention_forward(query: Tensor,
                                 ...
                                 vdim=None) -> Tuple[Tensor, Optional[Tensor]]:
    r"""
    Args:
