...
class LaneEncoder(nn.Module):
    ...
    def forward(self, data: dict):
        ...
        lane_vector = torch.cat([data["lane_positions"][:,:,:-1], data["lane_positions"][:,:,1:], lane_vector_dist.unsqueeze(-1)], dim=-1)
        ...
        lane_pt_padding_mask = ((lane_pt_padding_mask[:,:,:-1] + lane_pt_padding_mask[:,:,1:]) > 1).bool()
        ...
        # lane_actor_feat = lane_actor_feat 
        # + lane_pos_embed
